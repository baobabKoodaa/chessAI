...
public class BlackMagicV0 extends Evaluator {
    ...
    public static final double CHECK_BONUS = 50;
    ...
    public void scoreMobilityAndCaptures() {
        ...
        /** If sideToMove is under check, erase discovered capture potentials of that side
          *    TODO: investigate options to capture the checking piece  */
        ...
        if (sqControlCount[enemyColor][x][y] > 0) {
            capBest[color] = new double[2];
            /* Not erasing CapAlt, capturity bonus? */
        }
        ...
        /* sideToMove: gets score for best naive captureValue
         *      Because unit pins have been considered earlier, there are no more illegal
                moves that we would incorrectly give score for the sideToMove */
